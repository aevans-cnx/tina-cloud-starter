...
blocks:
  - background: bg-indigo-50/80
    text: 'Live Workshop: Agentic AI Test Accelerator - September 30, 2025'
    url: 'https://nextwave.to/register/ai-testing-workshop'
    _template: callout
  - background: bg-white/80
    headline: Is Your QA team ready for AI-driven testing?
    tagline: >-
      AI testing hype vs reality. Practical steps for using AI in test
      automation.
    actions:
      - label: Download the AI Testing Strategy Guide Book
        type: button
        icon:
          name: BiArrowFromTop
          color: blue
          style: float
        link: /resources/ai-testing-strategy-guide-book
      - label: Sign up for the Agentic AI Testing Workshop
        type: link
        icon:
